...
export default function TermsAndConditions({ onAgree }) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-white p-6 px-2 sm:px-6">
      <div className="max-w-lg w-full text-left p-4 sm:p-6 rounded-lg shadow mb-6">
        ...
        <div
          ...
          className="text-base leading-relaxed overflow-y-auto border border-gray-300 rounded p-4 bg-white text-justify"
          style={{ maxHeight: 300 }}
        >
      ...
      <div className="flex flex-col items-start w-full max-w-lg px-2 sm:px-0">
